...
{	//cout << "LIDAR CALLBACK WORKING\t";
	...
	if(true){
		...
		// LANE ADDING
		 ...
		 int LaneMapShift = -62; // temporary testing values
		 int CamDist = -71; // temporary testing values
...
{	cout << "Start with this node\n";
	...
	pub_local_map = MapPubNode.advertise<nav_msgs::OccupancyGrid>("/occ_map",1);
